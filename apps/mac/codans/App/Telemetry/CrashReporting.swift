...
/// One-shot bootstrap for the Sentry SDK. Called from `CodansApp.init()`
...
/// * The release name is pinned to `codans@<CFBundleShortVersionString>`
...
enum CrashReporting {
  ...
  struct Configuration: Equatable {
    ...
    init?(infoDictionary: [String: Any]) {
      ...
      if let version = infoDictionary["CFBundleShortVersionString"] as? String,
        !version.isEmpty
      {
        self.releaseName = "codans@\(version)"
      } else {
  ...
  private static let logger = Logger(subsystem: "com.gumpw.codans.telemetry", category: "crash-reporting")
