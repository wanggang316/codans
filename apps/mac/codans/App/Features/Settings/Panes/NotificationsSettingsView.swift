...
struct NotificationsSettingsView: View {
  ...
  var body: some View {
    ...
    .alert("Notifications are blocked", isPresented: $showPermissionAlert) {
      ...
      Text(
        "macOS is currently blocking notifications for Codans. "
  ...
  /// Deep-links into System Settings → Notifications → codans if the
  ...
  private func openSystemNotificationsPane() {
    let bundleID = Bundle.main.bundleIdentifier ?? "com.gumpw.codans"
