...
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans" 1' -fa 'project' -d 'List, create, and remove projects.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans" 1' -fa 'worktree' -d 'List, create, switch, and remove worktrees.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans" 1' -fa 'tab' -d 'List, create, switch, and close tabs.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans" 1' -fa 'pane' -d 'List, create, focus, close, label, read, reset, and send panes.'
