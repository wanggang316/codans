...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans agent wait" until' -l 'until' -d 'Condition: unknown, idle, working, blocked, error, finished, changed, or exit.' -rfka 'unknown idle working blocked error finished changed exit'
...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workspace create"' -l 'repo' -d 'Local repository path to include (repeatable).' -rfka ''
...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workspace add"' -l 'repo' -d 'Local repository path to add.' -rfka ''
