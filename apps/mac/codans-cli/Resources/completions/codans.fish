...
function __codans_parse_tokens -S
    ...
    case 'codans'
        ...
        case 'workspace'
            ...
            switch $unparsed_tokens[1]
            case 'create'
                __codans_parse_subcommand 1 'json' 'socket=' 'timeout=' 'project=+' 'repo=+' 'branch=' 'base=' 'existing' 'path=' 'description=' 'version' 'h/help'
            case 'add'
                __codans_parse_subcommand 1 'json' 'socket=' 'timeout=' 'project=+' 'repo=+' 'name=' 'branch=' 'base=' 'existing' 'role=' 'version' 'h/help'
            case 'drop'
...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workspace create" existing' -l 'existing' -d 'Check out an existing branch instead of creating one.'
...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workspace add" branch' -l 'branch' -d 'Branch to check out. Default: slug of the workspace title.' -rfka ''
...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workspace add" existing' -l 'existing' -d 'Check out an existing branch instead of creating one.'
