...
function __codans_parse_tokens -S
    ...
    case 'codans'
        ...
        case 'workflow'
            ...
            switch $unparsed_tokens[1]
            case 'create'
                __codans_parse_subcommand 0 'json' 'socket=' 'timeout=' 'template=' 'title=' 'input=' 'command-id=' 'version' 'h/help'
            case 'list'
                __codans_parse_subcommand 0 'json' 'socket=' 'timeout=' 'version' 'h/help'
            case 'status'
                __codans_parse_subcommand 1 'json' 'socket=' 'timeout=' 'version' 'h/help'
            case 'claim'
                __codans_parse_subcommand 1 'json' 'socket=' 'timeout=' 'step=' 'pane=' 'version' 'h/help'
            case 'deliver'
                __codans_parse_subcommand 1 'json' 'socket=' 'timeout=' 'attempt=' 'delivery-id=' 'pane=' 'content=' 'version' 'h/help'
            case 'cancel'
                __codans_parse_subcommand 1 'json' 'socket=' 'timeout=' 'version' 'h/help'
            end
        case 'help'
...
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans" 1' -fa 'workflow' -d 'Create workflows and explicitly claim and deliver their assignments.'
...
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans workflow" 1' -fa 'create' -d 'Create a workflow run.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans workflow" 1' -fa 'list' -d 'List workflow runs.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans workflow" 1' -fa 'status' -d 'Inspect a workflow run.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans workflow" 1' -fa 'claim' -d 'Claim a ready assignment.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans workflow" 1' -fa 'deliver' -d 'Deliver an assignment result.'
complete -c 'codans' -n '__codans_should_offer_completions_for_positional "codans workflow" 1' -fa 'cancel' -d 'Cancel workflow scheduling.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" socket' -l 'socket' -d 'Override the socket path (default: $CODANS_SOCKET_PATH → Debug /tmp/codans-dev-<uid>.sock, Release /tmp/codans-<uid>.sock).' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" template' -l 'template' -d 'Workflow template identifier.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" title' -l 'title' -d 'Run title.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" input' -l 'input' -d 'Task input; \'-\' reads stdin.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" command-id' -l 'command-id' -d 'Stable command UUID for an idempotent create retry.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow create" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow list" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow list" socket' -l 'socket' -d 'Override the socket path (default: $CODANS_SOCKET_PATH → Debug /tmp/codans-dev-<uid>.sock, Release /tmp/codans-<uid>.sock).' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow list" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow list" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow list" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow status" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow status" socket' -l 'socket' -d 'Override the socket path (default: $CODANS_SOCKET_PATH → Debug /tmp/codans-dev-<uid>.sock, Release /tmp/codans-<uid>.sock).' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow status" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow status" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow status" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" socket' -l 'socket' -d 'Override the socket path (default: $CODANS_SOCKET_PATH → Debug /tmp/codans-dev-<uid>.sock, Release /tmp/codans-<uid>.sock).' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" step' -l 'step' -d 'Step identifier.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" pane' -l 'pane' -d 'Pane UUID, handle, label, or \'current\'.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow claim" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" socket' -l 'socket' -d 'Override the socket path (default: $CODANS_SOCKET_PATH → Debug /tmp/codans-dev-<uid>.sock, Release /tmp/codans-<uid>.sock).' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" attempt' -l 'attempt' -d 'Claimed attempt UUID.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" delivery-id' -l 'delivery-id' -d 'Stable delivery UUID; reuse it when retrying the same submission.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" pane' -l 'pane' -d 'Pane UUID, handle, label, or \'current\'.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" content' -l 'content' -d 'Result content; \'-\' reads stdin.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow deliver" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow cancel" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow cancel" socket' -l 'socket' -d 'Override the socket path (default: $CODANS_SOCKET_PATH → Debug /tmp/codans-dev-<uid>.sock, Release /tmp/codans-<uid>.sock).' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow cancel" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow cancel" version' -l 'version' -d 'Show the version.'
complete -c 'codans' -n '__codans_should_offer_completions_for_flags_or_options "codans workflow cancel" h help' -s 'h' -l 'help' -d 'Show help information.'
